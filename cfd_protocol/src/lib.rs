...
pub fn build_cfd_transactions(
    ...
    let refund = {
        ...
        let sighash = tx.sighash().as_message();
...
pub fn punish_transaction(
    ...
    let satisfier = {
        ...
        let sig_publish_other = SECP256K1.sign(&sighash.as_message(), &publish_them_sk);
        ...
        let sig_revocation_other = SECP256K1.sign(&sighash.as_message(), &revocation_them_sk);
...
trait SigHashExt {
    fn as_message(&self) -> secp256k1_zkp::Message;
}
